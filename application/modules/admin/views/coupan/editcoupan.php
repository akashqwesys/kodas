<h1><img src="<?= base_url('assets/imgs/admin-user.png') ?>" class="header-img" style="margin-top:-3px;"> Edit COUPON</h1>
<hr>
<?php
$timeNow = time();
  ...
  <div class="col-md-4">
    <div class="panel panel-default">
      ...
      <form method="POST" action="" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?php echo $coupan_result['id']; ?>">
        <table class="table">
          <tbody>
            <tr>
              ...
              <td><input type="text" required id="name" name="name" placeholder="Name" value="<?php echo $coupan_result['name']; ?>" class="form-control"></td>
            </tr>
            <tr>
              ...
              <td><input type="text" required id="code" name="code" placeholder="Code" value="<?php echo $coupan_result['code']; ?>" class="form-control"></td>
            </tr>
            <tr>
              ...
              <td>
              <input type="text" required id="enddate" name="enddate" placeholder="Enter End Date" autocomplete="off" class="form-control datepicker" value="<?php echo date('d-m-Y', $coupan_result['enddate']); ?>">                
              </td>
            </tr> 
            ...
            <tr>
              ...
              <option value="Percentage" <?= $coupan_result['discounttype'] == 'Percentage' ? 'selected' : '' ?>>Percentage</option>
              <option value="Amount" <?= $coupan_result['discounttype'] == 'Amount' ? 'selected' : '' ?>>Amount</option>
            </select></td>
            </tr>            
            <tr>
              ...
              <td>
              <input type="number" required id="discount" name="discount" value="<?php echo $coupan_result['discount']; ?>" placeholder="Enter Discount" class="form-control">
              </td>
            </tr>            
            <tr>
              ...
              <td><select class="form-control" name="isactive">
                  ...
                  <option value="0" <?= $coupan_result['isactive'] == '0' ? 'selected' : '' ?>>Inactive</option>
                  <option value="1" <?= $coupan_result['isactive'] == '1' ? 'selected' : '' ?>>Active</option>
                </select>
              </td>
            </tr>
            <tr>
