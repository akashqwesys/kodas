...
<h1><img src="<?= base_url(
    'assets/imgs/settings-page.png'
) ?>" class="header-img" style="margin-top:-3px;">Settings</h1>
<?php
...
<div class="col-sm-6 col-md-4">
    <div class="panel panel-success col-h">
        ...
        <div class="panel-body">
            ...
            ) ?>" alt="Logo is deleted. Upload new!" class="img-responsive">
            <hr>
...
<div class="col-sm-6 col-md-4">
    <div class="panel panel-success col-h">
        ...
        <div class="panel-body">
            ...
            <?php } ?>
            <img src="<?= base_url(
                'attachments/banner/' . $banner1
            ) ?>" alt="Banner1 is deleted. Upload new!" class="img-responsive">
            <hr>
            <form accept-charset="utf-8" method="post" enctype="multipart/form-data" action="">
                <input type="file" name="banner1" size="20" />
                <input type="submit" value="Upload New" name="banner1" class="btn btn-default" />
            </form>
            <br>
            <form method="POST" action="">
                <div class="input-group">
                    <input class="form-control" name="bannerlink1" value="<?= $bannerlink1 ?>" type="text" placeholder="Banner 1 Link">
...
<div class="col-sm-6 col-md-4">
    <div class="panel panel-success col-h">
        ...
        <div class="panel-body">
            ...
            <?php } ?>
            <img src="<?= base_url(
                'attachments/banner/' . $banner2
            ) ?>" alt="Banner 2 is deleted. Upload new!" class="img-responsive">
            <hr>
            <form accept-charset="utf-8" method="post" enctype="multipart/form-data" action="">
                <input type="file" name="banner2" size="20" />
                <input type="submit" value="Upload New" name="banner2" class="btn btn-default" />
            </form>
            <br>
            <form method="POST" action="">
                <div class="input-group">
                    <input class="form-control" name="bannerlink2" value="<?= $bannerlink2 ?>" type="text" placeholder="Banner 2 Link">
                    <span class="input-group-btn">
                        <button class="btn btn-default" value="" placeholder="Find product.." type="submit">
                        <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                        </button>
...
<div class="col-sm-6 col-md-4">
    <div class="panel panel-success col-h">
        <div class="panel-heading">Pre-launch Banner</div>
        <div class="panel-body">
            <?php if ($this->session->flashdata('resultPrelaunchPublish')) { ?>
            <div class="alert alert-info"><?= $this->session->flashdata(
                'resultPrelaunchPublish'
            ) ?></div>
            <?php } ?>
            <img src="<?= isset($prelaunchimg)
                ? base_url('attachments/site_logo/' . $prelaunchimg)
                : '' ?>" alt="Pre-launch is deleted. Upload new!" class="img-responsive">
            <hr>
            <form accept-charset="utf-8" method="post" enctype="multipart/form-data" action="">
                <input type="file" name="prelaunchimg" size="20" />
                <input type="submit" value="Upload New" name="PrelaunchPublish" class="btn btn-default" />
            </form>
        </div>
    </div>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="">
                <div class="form-group" style="position: relative;">
                    <input type="text" style="padding-left:25px;" placeholder="Lon-Lat" class="form-control" name="footerContactAddr" value="<?= $footerContactAddr ?>">
                    <i class="fa fa-map-marker" style="position: absolute;top:10px;left:10px;"></i>
                </div>
                <div class="form-group" style="position: relative;">
                    <i class="fa fa-shopping-cart" style="position: absolute;top:10px;left:10px;"></i>
                    <input type="text" style="padding-left:25px;" placeholder="Store Name" class="form-control" name="footerContactStoname" value="<?= $footerContactStoname ?>">
                </div>
                <div class="form-group" style="position: relative;">
                    <i class="fa fa-phone" style="position: absolute;top:10px;left:10px;"></i>
                    <input type="text" style="padding-left:25px;" placeholder="Mobile No" class="form-control" name="footerContactPhone" value="<?= $footerContactPhone ?>">
                </div>
                <div class="form-group" style="position: relative;">
                    <i class="fa fa-phone" style="position: absolute;top:10px;left:10px;"></i>
                    <input type="text" style="padding-left:25px;" placeholder="Whatsapp No" class="form-control" name="footerContactwPhone" value="<?= $footerContactwPhone ?>">
                </div>
                <div class="form-group" style="position: relative;">
                    <i class="fa fa-envelope" style="position: absolute;top:10px;left:10px;"></i>
                    <i class="fa fa-map-marker" style="position: absolute;top:10px;left:10px;"></i>
                    <input type="text" style="padding-left:25px;" placeholder="Address" class="form-control" name="footerContactwAddress" value="<?= $footerContactwAddress ?>">
                </div>
                <div class="form-group" style="position: relative;">
                    <i class="fa fa-link" style="position: absolute;top:10px;left:10px;"></i>
                    <input type="text" style="padding-left:25px;" placeholder="WebsiteLink" class="form-control" name="footerContactwWeblink" value="<?= $footerContactwWeblink ?>">
                </div>
                <div class="form-group" style="position: relative;">
                    <i class="fa fa-envelope" style="position: absolute;top:10px;left:10px;"></i>
                ...
                <div class="form-group" style="position: relative;">
                    <i class="fa fa-bank" style="position: absolute;top:10px;left:10px;"></i>
                    <input type="text" style="padding-left:25px;" placeholder="Account Number" class="form-control" name="footerContactAccNo" value="<?= $footerContactAccNo ?>">
                </div>
                <div class="form-group" style="position: relative;">
                    <i class="fa fa-bank" style="position: absolute;top:10px;left:10px;"></i>
                    <input type="text" style="padding-left:25px;" placeholder="IFSC Code" class="form-control" name="footerContactIFSCode" value="<?= $footerContactIFSCode ?>">
                </div>
                <div class="form-group" style="position: relative;">
                    <i class="fa fa-user" style="position: absolute;top:10px;left:10px;"></i>
                    <input type="text" style="padding-left:25px;" placeholder="Holder Name" class="form-control" name="footerContactHoldname" value="<?= $footerContactHoldname ?>">
                </div>
                <div class="form-group" style="position: relative;">
                    <i class="fa fa-percent" style="position: absolute;top:10px;left:10px;"></i>
                    <input type="text" style="padding-left:25px;" placeholder="GST No." class="form-control" name="footerContactGSTno" value="<?= $footerContactGSTno ?>">
                </div>
                <div class="form-group">
...
<!--  <div class="col-sm-6 col-md-4">
    <div class="panel panel-success col-h">
        <div class="panel-heading">Banner Text</div>
    </div>
</div>
-->
<div class="col-sm-6 col-md-4">
    <div class="panel panel-success col-h">
        <div class="panel-heading">Banner Section</div>
        <div class="panel-body">
            ...
            <form method="POST" action="">
                <div class="input-group">
                    <input class="form-control" name="banner" value="<?= $banner ?>" type="text" placeholder="Banner Text">
                    <span class="input-group-btn">
                        <button class="btn btn-default" value="" placeholder="Find product.." type="submit">
                        <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                        </button>
        ...
        <div class="panel-body">
            <?php if ($this->session->flashdata('bannerheading')) { ?>
            <div class="alert alert-info"><?= $this->session->flashdata(
                'bannerheading'
            ) ?></div>
            <?php } ?>
            <form method="POST" action="">
                <div class="input-group">
                    <input class="form-control" name="bannerheading" value="<?= $bannerheading ?>" type="text" placeholder="Banner Heading">
                    <span class="input-group-btn">
                        <button class="btn btn-default" value="" placeholder="Find product.." type="submit">
                        <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                        </button>
        ...
        <div class="panel-body">
            <?php if ($this->session->flashdata('bannersubheading')) { ?>
            <div class="alert alert-info"><?= $this->session->flashdata(
                'bannersubheading'
            ) ?></div>
            <?php } ?>
            <form method="POST" action="">
                <div class="input-group">
                    <input class="form-control" name="bannersubheading" value="<?= $bannersubheading ?>" type="text" placeholder="Banner Sub Heading">
                    <span class="input-group-btn">
                        <button class="btn btn-default" value="" placeholder="Find product.." type="submit">
                        <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                        </button>
    ...
    <div class="panel panel-success col-h">
        <div class="panel-heading">GST</div>
        <div class="panel-body">
            <?php if ($this->session->flashdata('addgstpersontage')) { ?>
            <div class="alert alert-info"><?= $this->session->flashdata(
                'addgstpersontage'
            ) ?></div>
            <?php } ?>
            <form method="POST" action="">
                <div class="input-group">
                    <input class="form-control" name="addgst" value="<?= $addgst ?>" type="text" placeholder="GST Tex">
                    <span class="input-group-btn">
                        <button class="btn btn-default" value="" placeholder="" type="submit">
                        <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                        </button>
                    </span>
                </div>
...
<!--  <div class="col-sm-6 col-md-4">
    <div class="panel panel-success col-h">
        <div class="panel-heading">Banner Section Sub-heading</div>
    </div>
</div> -->
<div class="col-sm-6 col-md-4">
    <div class="panel panel-success col-h">
    ...
    <div class="panel panel-success col-h">
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="">
                <div class="input-group">
                    <input class="form-control" name="cartlimitset" value="<?= $cartlimitset ?>" type="text">
                    <span class="input-group-btn">
                        <button class="btn btn-default" value="" placeholder="Find product.." type="submit">
                        <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                        </button>
