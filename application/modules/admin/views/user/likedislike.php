...
<h1 style="text-transform: capitalize;"><img src="<?= base_url('assets/imgs/list-user.png') ?>" class="header-img" style="margin-top:-2px;">
  Product Review (<span><?php if($_GET['status'] == 1){echo 'Like Users';}elseif($_GET['status'] == 0){echo 'Dislike Users';}?></span>)
</h1>
<hr>
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      <table class="table table-bordered" cellpadding="4" style="width:50%;">
        ...
        <tbody>
          <tr>
            <td class="text-center"><?php if(isset($productinfo[0]['product_image']) && $productinfo[0]['product_image'] != ''){
			  echo '<a href="'.base_url('attachments/shop_images/'.$productinfo[0]['product_image']).'" download><img src="'.base_url('attachments/shop_images/'.$productinfo[0]['product_image']).'" height="75" width="75"></a>';
			  } ?></td>
