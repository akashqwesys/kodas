...
foreach ($userlist as $row) {
		?>
            <tr>
              <td style="cursor: pointer;" onclick="mychatroomagent(<?=$row->agent_id;?>,'<?=$row->name;?>');"><?=$row->name;?>
        ...
        <div class="col-md-12">
          <div class="panel panel-default">
            ...
            <form style="padding: 10px 20px;" method="post">
              ...
              <button type="button" name="sendmessagechat" class="sendmsgtochatagent btn btn-primary">Send</button>
            </form>
          </div>
        </div>
      </div>
