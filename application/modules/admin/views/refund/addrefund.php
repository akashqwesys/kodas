...
<h1>
  <!-- <img src="<?= base_url(
                  ...
                  ) ?>" class="header-img" style="margin-top:-3px;">  -->Add Refund Policy
</h1>
<hr>
<?php
$timeNow = time();
  ...
  <div class="col-md-12">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-file"></i> Refund Policy Details</h3>
      </div>
      <form method="POST" action="" enctype="multipart/form-data">
        <table class="table">
          <tbody>
            <tr>
              <td style="width: 5%;"><a data-toggle="tooltip" title="" class="btn btn-info btn-xs" data-original-title="Refund Policy"><i class="fa fa-user fa-fw"></i></a></td>
