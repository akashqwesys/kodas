...
class Slider_model extends CI_Model {
	...
	public function getSlider($limit, $page, $search_title = null, $orderby = null, $category = null, $vendor = null) {
		if ($orderby !== null) {
			$ord = explode('=', $orderby);
		...
		$query = $this->db->select('products_translations.title,app_slider.imagename,app_slider.position,app_slider.id')->get('app_slider', $limit, $page);
	...
	public function getoneSlider($id) {
		$this->db->where('app_slider.id', $id);
		$this->db->join('products_translations', 'products_translations.for_id = app_slider.productid', 'left');
		$query = $this->db->select('products_translations.title,app_slider.imagename,app_slider.position,app_slider.id,app_slider.productid,app_slider.youtubeurl')->get('app_slider');
