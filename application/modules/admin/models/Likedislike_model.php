...
class Likedislike_model extends CI_Model
{
	...
	public function getproductinfo($id)
	{
        ...
        $this->db->limit(1);
        $query = $this->db->select('pre_products.id as Id, pre_products_translations.title, pre_products.image as product_image, pre_products.folder as imgfolder, pre_products.product_type as Type, pre_products.product_pcs as Pcs, pre_products.min_qty as MinQty, pre_products.quantity as product_quantity_available, pre_products_translations.description, pre_products_translations.price, pre_products_translations.old_price, pre_products_translations.basic_description')->get('pre_products');
