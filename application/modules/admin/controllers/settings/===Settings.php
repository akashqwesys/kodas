...
class Settings extends ADMIN_Controller
{
    ...
    private function postChecker()
    {
        ...
        if (isset($_POST['footerContacts'])) {
			...
			$this->Home_admin_model->setValueStore('footerContactStoname', $_POST['footerContactStoname']);
            $this->Home_admin_model->setValueStore('footerContactPhone', $_POST['footerContactPhone']);
			$this->Home_admin_model->setValueStore('footerContactwPhone', $_POST['footerContactwPhone']);
			$this->Home_admin_model->setValueStore('footerContactwAddress', $_POST['footerContactwAddress']);
			$this->Home_admin_model->setValueStore('footerContactwWeblink', $_POST['footerContactwWeblink']);
            $this->Home_admin_model->setValueStore('footerContactEmail', $_POST['footerContactEmail']);
			$this->Home_admin_model->setValueStore('footerContactAccNo', $_POST['footerContactAccNo']);
			$this->Home_admin_model->setValueStore('footerContactIFSCode', $_POST['footerContactIFSCode']);
			$this->Home_admin_model->setValueStore('footerContactHoldname', $_POST['footerContactHoldname']);
			$this->Home_admin_model->setValueStore('footerContactGSTno', $_POST['footerContactGSTno']);
